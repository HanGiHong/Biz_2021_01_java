...
public class WrapperEx_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * wrapper class 변수를 선언하는 기본 키워드 int, long, float, double, boolean, char 초기에
		 * java를 만들때 값을 저장하는 최소한의 기능만을 구현했다. 이후에 필요에 의해서 기능들을 추가해야 하는데 기본 키워드의 기능을
		 * 변경하기에는 어려움이 있었다.
		 * 
