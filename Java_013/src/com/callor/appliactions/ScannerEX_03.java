...
public class ScannerEX_03 {
	...
	public static void main(String[] args) {
		...
		/*
		 * nextInt()와 nextLine()을 번갈아 사용하는 코드에서 문제를 일으키는 해결할 수 없는 부분이 있어서 문제를 극복하기 위한
		 * 방법으로 nextInt()를 사용하지 않고 nextLine()만 사용하여 키보드 입력을 받는다.
		 * 
		 * 과목의 점수를 nextLine() method를 사용하여 입력받았다
		 * 
		 * 합계가 이상하다 숫자 덧셈이 아닌 문자열 연결 결과로 출력 되고있다.
		 */
