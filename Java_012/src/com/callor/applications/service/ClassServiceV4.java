...
public class ClassServiceV4 {
	...
	/*
	 * method 선언문에 변수선언키워드 (int, float...)이 있으면 이 키워드를 return type 이라고 부른다.
	 */
	...
	/*
	 * method 선언문에 void 이외의 return type이 있을경우 method에는 반드시 return 명령문이 value와 함께 있어야
	 * 한다.
	 */
	...
	// return 하라
	// 이떄 return 하는 연산 결과값이 float 이기 때문에
