...
public class Numbers_01 {
	...
	public static void main(String[] args) {
		...
		// ArrayIndesOutOfBounds Exception 이 발생한다.

		// 또는
		// intNum[-1] = 100 이라는 명령은 절대 사용불가
		// 첨자는 0부터 배열.length -1까지의 자연수만 가능하다

		int[] intNums = new int[10]; // 배열 10개 선언

		for (int i = 0; i < intNums.length; i++) { // i가 10보다 작을경우 i가 1씩 증가)
			intNums[i] = 100;
		}
		// 100.101.102......109
