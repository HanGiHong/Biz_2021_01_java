 ...
 * 3. 처음생성할 때 몇개의 데이터를 저장할 지 결정하지 않고
 * 4. 필요에 따라서 데이터를 추가, 수정, 삭제 할 수 있다.
 *  - 배열은 처음 생성한 개수를 변경하면 저장되어있던 데이터를
 *    사용할 수 없게 된다.
...
public class List_02 {
	...
	public static void main(String[] args) {
		...
		//  추가할 수 있다.
		// <String> : Generic type
		// strList1 은 ArrayList 객체이지만
		// 여기에는 문자열만 저장하도록 하겠다.
		
		// Generic type은 int. float, lang, double 등은 사용불가.
		// Generic type은 Integer, Float, Long, Double, String등을
		// 사용해야한다.
		
		// Generic type은 VO클래스를 사용할 수 있다.
