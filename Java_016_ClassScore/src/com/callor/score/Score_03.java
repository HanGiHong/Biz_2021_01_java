...
public class Score_03 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 * scoreVO(value Object, VO 클래스) 정보처리를 수행하는 데이터들을 서로 그룹으로 묶어서 한꺼번에 관리할 수 있도록 만들어
		 * 놓은 클래스
		 * 
		 * 객체 : 정보처리를 수행하는 최소한의 데이터 그룹 학생이름, 국어, 영어, 수학, 총점, 평균 데이터를 하나의 그룹으로 묶어서 처리하겠다
		 * 
		 */
