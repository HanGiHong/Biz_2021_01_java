...
public class Array_01TeaCher {

	public static void main(String[] args) {

		Random rnd = new Random();

		// rnd 인스턴스 nextInt() method를 호출(실행)하라
		// 매개변수값으로 100을 전달하라

		// Random 클래스의 nextInt() method에
		// 정수 100을 전달하고 실행하여 return 하는 결과를 num변수에 저장
		// num변수에는 0~99까지 중 1개의 숫자가 저장
		int num = rnd.nextInt(100);

		// num 변수에는 1 ~ 100까지 중 1개의 숫자가 저장
