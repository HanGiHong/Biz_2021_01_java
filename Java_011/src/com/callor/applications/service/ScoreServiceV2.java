...
public class ScoreServiceV2 {
	...
	/*
	 * 성적을 출력하는 용도만의 method 매개변수(Parameter, argument) method()안에서 선언된 변수들 여기에서는
	...
	/*
	 * 누군가가 3개의 정수값을 전달하면서 호출을 하면 각각의 intKor, intEng, intMath에 받고 세 변수의 값을 덧셈하여
	 * intSum에 저장하고 저장된 값을 Console에 출력
	 */
